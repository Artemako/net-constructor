...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon12 = QIcon()
        icon12.addFile(u":/white-icons/resources/white-icons/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/white-icons/resources/white-icons/show-properties.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.action_parameters.setIcon(icon13)
        ...
        # Подменю с темами убрано, теперь выбор темы в диалоге настроек
    ...
    def retranslateUi(self, MainWindow):
        ...
        # Действия тем убраны, теперь выбор темы в диалоге настроек
        ...
        # Подменю тем убрано, теперь выбор темы в диалоге настроек
